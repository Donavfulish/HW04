...
- Name: fr18-order-admin.spec.ts >> FR-18 Order Admin | Run by: 23127044 >> FR18-DT-01 BUG revenue doubles delivered amount
- Location: specs/fr18-order-admin.spec.ts:147:9

# Error details

```
Error: BUG-C1: revenue delta should be 500000, got 1000000 (order #120)
  ...
  - generic [ref=f1e15]:
    ...
    - generic [ref=f1e17]:
      - generic [ref=f1e18]:
        ...
        - paragraph [ref=f1e20]: 10,625,926 ₫
      - generic [ref=f1e21]:
        - heading "Tổng số đơn hàng" [level=3] [ref=f1e22]
        - paragraph [ref=f1e23]: "120"
```
